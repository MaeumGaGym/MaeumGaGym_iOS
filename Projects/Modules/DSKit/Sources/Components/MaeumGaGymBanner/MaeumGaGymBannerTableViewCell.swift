...
public class MaeumGaGymBannerTableViewCell: UITableViewCell {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(MaeumGaGymeBannerCell.self,
                                forCellWithReuseIdentifier: MaeumGaGymeBannerCell.identifier)
        return collectionView
    }()
    
    private lazy var indicatorView: MaeumGaGymIndicatorView = {
        guard let viewModel = bannerModel else { return MaeumGaGymIndicatorView(viewModel: bannerModel!) }
        let indicatorView = MaeumGaGymIndicatorView(viewModel: viewModel)
    ...
    public func setUp(_ model: MaeumGaGymBannerModel) {
...
extension MaeumGaGymBannerTableViewCell: UICollectionViewDelegateFlowLayout {
...
extension MaeumGaGymBannerTableViewCell: UICollectionViewDataSource {
...
extension MaeumGaGymBannerTableViewCell {
