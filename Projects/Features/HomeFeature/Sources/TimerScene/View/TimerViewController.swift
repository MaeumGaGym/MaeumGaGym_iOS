...
public class TimerViewController: BaseViewController<TimerViewModel> {
    ...
    private lazy var timerCollectionView = UICollectionView(frame: .zero,
                                                            collectionViewLayout: self.collectionViewLayout
    ).then {
        $0.register(TimerHeaderCollectionViewCell.self,
                    forCellWithReuseIdentifier: TimerHeaderCollectionViewCell.identifier)
        $0.register(TimerCollectionViewCell.self,
    ...
    public override func layout() {
        view.addSubviews([navBeforeButton,
                          navAddButton,
                          navEditButton,
                          editView,
                          progressBarView,
