...
public class PostureDetailPickeTableViewCell: UITableViewCell, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        pickleColellectionView = UICollectionView(frame: .zero, collectionViewLayout: layout).then {
            $0.register(PostureDetailPickleCollectionViewCell.self, forCellWithReuseIdentifier: PostureDetailPickleCollectionViewCell.identifier)
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: PostureDetailPickleCollectionViewCell.identifier, for: indexPath) as! PostureDetailPickleCollectionViewCell
